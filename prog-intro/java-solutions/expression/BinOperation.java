...
public abstract class BinOperation implements MyExpression {
    ...
    abstract protected BigInteger calculate(BigInteger value1, BigInteger value2);
    ...
    public String toMiniString() {
        ...
        if (element2.priority() < priority() || 
            element2.priority() == priority() && (secondBrackets() || element2.priority() == 2 && element2.secondBrackets())
        ) {
